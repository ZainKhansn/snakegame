...
msg_font = pygame.font.SysFont("Courier", 10)
...
def draw_bdfood(x, y, radius):
    pygame.draw.circle(screen, food_color2, [int(x), int(y)], radius)
...
def main():
    ...
    bdfoodx = round(random.randrange(0, width - snake_block) / 10.0) * 10
    bdfoody = round(random.randrange(0, height - snake_block) / 10.0) * 10
    ...
    while not game_over:
        ...
        if x1 == foodx and y1 == foody:
            ...
            snake_length += 1
        if x1 == bdfoodx and y1 == bdfoody:
            bdfoodx = round(random.randrange(0, width - snake_block) / 10.0) * 10.0
            bdfoody = round(random.randrange(0, height - snake_block) / 10.0) * 10.0
            snake_length += 1
